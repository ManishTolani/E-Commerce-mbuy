   ...
   <div class="aa-catg-head-banner-area">
     <div class="container">
      <div class="aa-catg-head-banner-content">
        <h2><?php echo $_GET['sub_cat']; ?></h2>
        <ol class="breadcrumb">
          <li><a href="index.php">Home</a></li>         
          <li><a href="#"><?php echo $_GET['sub_cat']; ?></a></li>
          <li class="active"><?php 
                                $pid =  $_GET['pid'];
                                 $pro = "SELECT * FROM `dailyshop_products` WHERE `p_id` =".$pid;
                ...
                <div class="col-md-7 col-sm-7 col-xs-12">
                  <div class="aa-product-view-content">
                    ...
                    <div class="aa-price-block">
                      <span class="aa-product-view-price">Rs <?=$price?></span>
                    ...
                    <div class="aa-prod-view-bottom">
                      <a class="aa-add-to-cart-btn" href="cart.php?pid=<?=$pid?>">Add To Cart</a>
